function App() {
  return (
    <>
      <header className="">
        {/* header part 1 */}
        <div className="sm:hidden lg:flex justify-between items-center bg-[#080D41] text-white px-4 h-16  text-lg   ">
          <div className="">
        ...
        {/* header part 1 end */}
        {/* header part 2 */}
        <div className="sm:hidden  lg:w-full lg:grid lg:grid-cols-4 lg:items-center lg:gap-6">
          {/* Logo */}
          <div className="">
